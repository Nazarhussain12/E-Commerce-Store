...
if (!isset($_SESSION['customer_email'])) {
    ...
    $ip = getIp(); // Function to get the user's IP address

    // Clear the cart for this user/IP
    require "db_connection.php"; // File where your database connection is set up
   

    $delete_cart = "DELETE FROM cart WHERE ip_add='$ip'";
    $run_delete = mysqli_query($con, $delete_cart);
    echo "<script>alert('You are not logged in. Log in to see the cart.');</script>";
    // Optionally, reset other session variables related to shopping
    unset($_SESSION['cart_items']); // Example: if you store cart items in a session variable
}
   ...
   <?php if(isset($_SESSION['customer_email'])): ?>
    ...
    <?php if(isset($_SESSION['customer_email'])): ?>
        ...
        <div class="formatted-name">
            ...
            echo 'Check your Cart ' . htmlspecialchars($c_name) . ', check out now and get your Delivery Done';
            ?>
        </div>
        <div class="dropdown-content">
            <a href="profile.php">Profile</a>
    ...
    <?php endif; ?>
                        ...
                        <br><br>
                        <a class="gotocart" href="index.php">Back to Shop</a>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <table >
                            ...
                            <tr >
                                ...
                                <td>
    <a href="all_products.php" class="continue-shopping-button">Continue Shopping</a>
</td>
