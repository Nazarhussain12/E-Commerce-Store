...
color: #333333;
 ...
 /* Overriding hover color change effect for contact form only */
    ...
    <div class="header_wrapper">
        ...
        <div class="menubar">
            <ul id="menu">
                ...
                <li><a href="all_products.php#content_area">Explore</a></li>
            </ul>
   ...
   <?php if(isset($_SESSION['customer_email'])): ?>
    ...
    <?php if(isset($_SESSION['customer_email'])): ?>
        ...
        <div class="formatted-name">
            ...
            echo 'Enjoy Shopping ' . htmlspecialchars($c_name);
            ?>
        </div>
        <div class="dropdown-content">
            <a href="profile.php">Profile</a>
