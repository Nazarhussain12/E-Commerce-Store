   ...
   <?php if(isset($_SESSION['customer_email'])): ?>
    ...
    <?php if(isset($_SESSION['customer_email'])): ?>
        ...
        <div class="formatted-name">
            ...
            echo 'Welcome ' . htmlspecialchars($c_name);
            ?>
        </div>
        <div class="dropdown-content">
            <a href="profile.php">Profile</a>
                ...
                <div class="products_box">
                    ...
                    if(isset($_GET['pro_id'])) {
                        ...
                        while ($row_pro = mysqli_fetch_array($run_pro)) {
                            ...
                            echo "
                            <div class='single_product' style='border: 1px solid #ff5722; padding: 15px; text-align: center; border-radius: 10px; background-color: white; margin-bottom: 20px;'>
                                <h3 style='color: #333; font-size: 20px;'>$pro_title</h3>
                                <img src='admin/product_images/$pro_image' style='max-width: 100%; height: 80%; border-radius: 5px;'>
                                <p style='color: #ff5722; font-size: 18px; font-weight: bold; margin-top: 10px;'>Rs $pro_price/-</p>
                                <p style='color: #555; font-size: 14px;'>$pro_desc</p> 
                                <a href='index.php' style='text-decoration: none; color: #ff5722; font-weight: bold;'>Go Back</a>
                                <a href='index.php?pro_id=$pro_id' style='display: inline-block; margin-top: 10px; text-decoration: none;'>
                                    <button style='background-color: #ff5722; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer;'>Add to Cart</button>
                                </a>
                            </div>
                        ";
